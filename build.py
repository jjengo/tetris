...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "tetris.py"
 
        #Name of program
        self.project_name = "Tetris"
        ...
        #Auhor of program
        self.author_name = "Jonathan Jengo"
        self.author_email = "jonathan.jengo@gmail.com"
        self.copyright = "Copyright (c) 2013 Jonathan Jengo"
 
        #Description
        self.project_description = "Tetris clone."
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["sounds", "images"]
